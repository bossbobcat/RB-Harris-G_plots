...
x=c(5.50, 5.00, 4.90, 6.40, 5.10, 5.20,
    5.20, 5.00, 4.70, 4.00, 4.50, 4.20,
    4.10, 4.56, 5.01, 4.70, 3.13, 3.12,
    2.68, 2.77, 2.70, 2.36, 4.38, 5.73,
    4.35, 6.81, 1.91, 2.66, 2.61, 1.68, 
    2.04, 2.08, 2.13, 3.80, 3.73, 3.71, 
    3.28, 3.90, 4.00, 3.80, 4.10, 3.90, 
    4.05, 4.00, 3.95, 4.00, 4.50, 4.50, 
    4.20, 4.55, 4.65, 4.10, 4.25, 4.30, 
    4.50, 4.70, 5.15, 4.30, 4.50, 4.90,
    5.00, 5.35, 5.15, 5.25, 5.80, 5.85, 
    5.90, 5.75, 6.25, 6.05, 5.90, 3.60, 
    4.10, 4.50, 5.30, 4.85, 5.30, 5.45,
    5.10, 5.30, 5.20, 5.30, 5.25, 4.75, 
    4.50, 4.20, 4.00, 4.15, 4.25, 4.30, 
    3.75, 3.95, 3.51, 4.13, 5.40, 5.00, 
    2.10, 4.60, 3.20, 2.50, 4.10, 3.50, 
    3.20, 3.30, 4.60, 4.30, 4.30, 4.50, 
    5.50, 4.60, 4.90, 4.30, 3.00, 3.40,
    3.70, 4.40, 4.90, 4.90, 5.00
)
...
F.GELLoG = GELLoG_cdf(x,lambda=3.7014,c=1.0472,alpha=0.4907, delta=15.8740)
...
F.APTLW = APTLW_cdf(x,theta=0.7681,alpha=60.4077, beta=3.3023 ,lambda=0.0059)
...
F.TLGW = TLGW_cdf(x,alpha=101.02,
                  theta=  0.012318 ,
                  lambda= 0.15012,
                  beta=16.077)
